...
description: "Terms and conditions for {{legalName}}"
lastUpdated: 2026-04-22
---

## 1. Definitions

- **"Seller"** refers to {{legalName}}, located in {{city}}, {{region}}, {{country}}.
...
All orders require a minimum quantity of one {{containerType}} container (approximately {{moqTons}}+ metric tons). We do not process orders below this threshold. Sample orders may be arranged separately upon request.
...
- **FOB (Free On Board):** Risk transfers when goods are loaded onto the vessel at the port of {{port}}.
...
Primary port of loading: {{port}}, {{country}}.
...
These terms are governed by the laws of the {{governingLaw}}. Any disputes shall be resolved through good-faith negotiation. If unresolved, disputes shall be submitted to arbitration in accordance with the rules of the {{arbitrationInstitution}} ({{arbitrationInstitutionShort}}) in {{arbitrationSeat}}.
...
WhatsApp: [{{phoneDisplay}}](https://wa.me/{{whatsappDigits}})
