...
export default defineConfig({
  ...
  integrations: [
    sitemap({
      ...
      // the default for the page's hero URL here (a tiny route→URL
      // map is the natural next step — keep it inline until there's
      // more than one entry, per CLAUDE.md "no abstractions for
      // single-use code").
      serialize(item) {
  ...
  // declared in `public/_headers`. See plans/analyze-website-structure-
  // and-reactive-charm.md for the full intake convention.
  image: {
